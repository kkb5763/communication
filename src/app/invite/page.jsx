    ...
    <div className="min-h-screen bg-[#fefdfb] text-[#4a3f35] font-[\'Noto Serif KR\'] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden pb-10">
        ...
        <div className="px-6 pt-8 text-center">
          <h1 className="text-3xl font-bold text-[#3e312b] tracking-wide mb-3">
            저희 결혼합니다
          </h1>
          ...
          <p className="text-base leading-relaxed whitespace-pre-line text-[#6b5e51] mb-6">
            서로가 마주 보던 두 사람이 이제 함께 같은 곳을 바라보며 새로운
            시작을 하려 합니다.lo 바쁘시더라도 오셔서 따뜻한 격려와 축복을
            부탁드립니다.
          </p>
          <p className="text-lg font-semibold mb-6">신랑 봉봉 & 신부 나랭</p>

          <div className="mt-10">
            <h2 className="text-lg font-semibold text-[#3e312b] mb-4">
              📍 오시는 길
            </h2>
            ...
            <div className="text-left text-sm text-[#5e5147] space-y-1">
              <p>
                <strong>인덕원 성당</strong>
              </p>
              <p>경기 안양시 동안구 인덕원로 41</p>
              <p>031-345-3456</p>
              <p className="mt-2">
                🚌 버스: 일반 6, 9, 11 / 마을버스 6-1 / 인덕원역 하차
              </p>
...
{/*}
          <div className="mt-10">
            ...
            <div className="relative w-full overflow-hidden rounded-xl shadow">
              ...
              <button
                onClick={prevSlide}
                className="absolute top-1/2 left-2 transform -translate-y-1/2 bg-white bg-opacity-80 rounded-full px-2"
              >
                ◀
              </button>
              <button
                onClick={nextSlide}
                className="absolute top-1/2 right-2 transform -translate-y-1/2 bg-white bg-opacity-80 rounded-full px-2"
              >
                ▶
              </button>
            </div>
          ...
          <div
            className="relative w-full overflow-hidden rounded-xl shadow cursor-pointer"
            onClick={() => (window.location.href = "/invite/gallery")}
          >
            <img
              src={images[current]}
              alt={`갤러리 ${current + 1}`}
            ...
            <div className="absolute bottom-3 left-0 right-0 flex justify-between px-4">
              <button
                ...
                className="bg-white bg-opacity-80 rounded-full px-3 py-1"
              >
                ◀
              </button>
              <button
          ...
          <div className="mt-10">
            ...
            <p className="text-sm text-center text-[#5e5147] mb-4">
              축복의 의미로 축의금을 전달해보세요.
            </p>
          ...
          <div className="mt-10">
            ...
            <form onSubmit={handleSubmit} className="text-left space-y-4">
              ...
              <button
                type="submit"
                className="bg-[#d36b6b] hover:bg-[#c85c5c] text-white font-bold py-2 px-4 rounded-full"
              >
                남기기
              </button>
            </form>
            ...
            <ul className="mt-6 space-y-2 text-left">
              {guestbook.map((entry) => (
                <li
                  key={entry.id}
                  className="p-3 border rounded-xl bg-[#fefaf7]"
                >
